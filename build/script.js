...
const source_temp = {
    ...
    getContentDetails(url) {
        ...
        const details = new PlatformVideoDetails({
            ...
            author: new PlatformAuthorLink(platform_creator_ID, video_info.videoData.owner.name, `${SPACE_URL_PREFIX}${video_info.videoData.owner.mid}`, video_info.videoData.owner.face, 69 // TODO hardcoded
            ),
            duration: video_play_details.data.dash.duration,
